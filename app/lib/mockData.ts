...
export const clients: Client[] = [
  ...
  },
  {
    ...
    lastReview: "—",
    summary: "Sem campanhas ativas no momento.",
    objective: "Avaliar abertura de oportunidades de campanha",
    metrics: { score: 100, ctrTrend: "sem dados", budgetStatus: "sem dados" },
    alerts: ["Sem campanhas ativas no momento"],
    recommendations: [
      "Definir estratégia inicial de campanha.",
      "Validar disponibilidade de budget e criativos.",
    ],
    actions: [{ title: "Conta em análise", detail: "Aguardando definição de posicionamento", when: "Hoje" }],
  },
  {
    id: 6,
    name: "Tritão Náutica",
    ...
    lastReview: "—",
    summary: "Sem campanhas ativas no momento.",
    objective: "Planejar a entrada inicial em tráfego pago",
    metrics: { score: 100, ctrTrend: "sem dados", budgetStatus: "sem dados" },
    alerts: ["Sem campanhas ativas no momento"],
    recommendations: [
      "Estruturar a oferta principal para o público certo.",
      "Preparar material visual para os primeiros testes.",
    ],
    actions: [{ title: "Prospectando abertura", detail: "Conta ainda sem campanha ativa", when: "Hoje" }],
  },
  {
    id: 7,
    name: "Rei da Parmegiana",
    slug: "rei-da-parmegiana",
    ...
    lastReview: "—",
    summary: "Sem campanhas ativas no momento.",
    objective: "Gerar mais pedidos com campanhas de aquisição",
    metrics: { score: 100, ctrTrend: "sem dados", budgetStatus: "sem dados" },
    alerts: ["Sem campanhas ativas no momento"],
    recommendations: [
      "Definir uma oferta promocional para tráfego inicial.",
      "Organizar os criativos para WhatsApp e Instagram.",
    ],
    actions: [{ title: "Conta em revisão", detail: "Aguardando confirmação de pauta comercial", when: "Hoje" }],
  },
  {
    id: 8,
    name: "Beatriz Lima Nutri",
    slug: "beatriz-lima-nutri",
    ...
    lastReview: "—",
    summary: "Sem campanhas ativas no momento.",
    objective: "Estruturar o primeiro ciclo de campanha",
    metrics: { score: 100, ctrTrend: "sem dados", budgetStatus: "sem dados" },
    alerts: ["Sem campanhas ativas no momento"],
    recommendations: [
      "Mapear o público ideal para os próximos testes.",
      "Criar uma proposta de valor clara para lead gen.",
    ],
    actions: [{ title: "Primeiros passos iniciados", detail: "Aguardando alinhamento de oferta", when: "Hoje" }],
  },
];
