...
type AppShellProps = { title:string; subtitle:string; activeLabel:string; children:ReactNode; actions?:ReactNode; sidebarStatus?:{lastUpdated:string|null}; variant?:"internal"|"portal"; sidebarItems?:NavItem[] };
...
export function AppShell({ title, subtitle, activeLabel, children, actions, sidebarStatus, variant = "internal", sidebarItems }: AppShellProps) {
  ...
  const legacySurface = activeLabel === "Financeiro" || activeLabel === "Integrações";
  return <div className="min-h-screen bg-[#08090d] text-zinc-100 selection:bg-[#ff5a3c]/30">
