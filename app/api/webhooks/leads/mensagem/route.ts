...
const REMETENTES_VALIDOS = ["lead", "ia", "humano"];

// Chamado pelo workflow n8n a cada mensagem trocada no WhatsApp do cliente,
// pra guardar o histórico de conversa vinculado ao lead certo.
